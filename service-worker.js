const CACHE_NAME = "maumcard-v64-12-sharp-kakao-preview";
const STATIC_ASSETS = [
  "/",
  "/index.html",
  "/card.html",
  "/view.html",
  "/manifest.webmanifest?v=6411",
  "/icon-192-v64.png?v=6411",
  "/icon-512-v64.png?v=6411",
  "/apple-touch-icon-v64.png?v=6411",
  "/favicon.ico?v=6411"
];
